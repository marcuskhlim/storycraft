...
export function EditorTab({
    ...
    const findSnapPointForInsert = useCallback(
        (
            ...
            // Cross-layer snapping: audio clips snap to video clip edges
            const isAudioLayer =
                draggingItem?.layerId === "voiceovers" ||
                draggingItem?.layerId === "music";
            if (isAudioLayer) {
                const videoLayer = layers.find((l) => l.id === "videos");
                if (videoLayer) {
                    for (const videoClip of videoLayer.items) {
                            ...
                            if (result?.url) {
                                ...
                                if (!item.metadata?.originalDuration) {
                                    const originalDuration =
                                        await getVideoDuration(result.url);
                                    item.metadata = {
                                        ...item.metadata,
                                        originalDuration,
                                    };
                        ...
                        if (resizeHandle === "start") {
                            ...
                            if (deltaTime > 0) {
                                ...
                                if (
                                    ...
                                    Math.abs(newStartTime - snappedStart) < 0.01
                                ) {
                            ...
                            if (deltaTime < 0) {
                                ...
                                if (hasTrimmableContent) {
                                    ...
                                    const maxExpandForTimeline =
                                        maxEnd -
                                        (resizeStartTime + resizeStartDuration);
                                    const maxExpand = Math.min(
                                        availableAtEnd,
    ...
    const handleDragMove = useCallback(
        (e: MouseEvent | React.MouseEvent) => {
            ...
            const originalItem = originalLayerItemsRef.current.find(
    ...
    const handleDragEnd = useCallback(() => {
        if (isDragging && draggingItem && dropIndicator) {
            const originalDraggedItem = originalLayerItemsRef.current.find(
                (i) => i.id === draggingItem.itemId,
            );
            ...
            if (originalDraggedItem) {
                ...
                updatedLayers = updatedLayers.map((l) => {
                    if (l.id !== draggingItem.layerId) return l;
                    const sortedItems = [...l.items].sort(
                        (a, b) => a.startTime - b.startTime,
                    );
    ...
    }, [isDragging, draggingItem, dropIndicator, layers]);
                    ...
                    <div className="relative pb-4 pt-4">
                        ...
                        <div className="mt-6 space-y-1">
                            {layers.map((layer) => (
                                <div
                                    key={layer.id}
                                    className="relative h-12 rounded border border-gray-200 bg-white"
                                >
                                    ...
                                    <div className="relative h-full">
                                        {layer.items.length > 0 ? (
                                            layer.items.map((item) => {
                                                ...
                                                const originalItem =
                                                    originalLayerItemsRef.current.find(
                                                        (i) => i.id === item.id,
                                                    );
                                                const isBeingPushed =
                                                    isDragging &&
                                                    ...
                                                    >
                                                        ...
                                                        hasContent ? (
                                                            ...
                                                            />
                                                              ...
                                                              "voiceover" &&
                                                          hasContent ? (
                                                            <div className="relative h-full w-full rounded border border-green-500/30 bg-green-500/10 p-1">
                                                                <AudioWaveform
                                                                    src={
                                                                        item.content!
                                                                    }
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={(
                                                                        ...
                                                                        e.stopPropagation();
                                                                        handleRemoveVoiceoverFromTimeline(
                                                                            item.id,
                                                                        );
                                                                    }}
                                                              ...
                                                              "music" &&
                                                          hasContent ? (
                                                            <div className="relative h-full w-full rounded border border-purple-500/30 bg-purple-500/10 p-1">
                                                                <AudioWaveform
                                                                    src={
                                                                        item.content!
                                                                    }
                                            ...
                                            <div className="flex h-full w-full items-center justify-center rounded border border-gray-200 bg-gray-100 p-1">
