...
export const SettingCard = memo(function SettingCard({
    ...
    const [editedName, setEditedName] = useState(setting.name);
    ...
    const handleSave = useCallback(() => {
        if (
            editedName !== setting.name ||
            editedDescription !== setting.description
        ) {
            onUpdate(index, {
                ...setting,
                name: editedName,
        ...
        setIsEditing(false);
    }, [editedName, editedDescription, setting, index, onUpdate]);
